...
/* =========================================================================
   Auto-refresh global: recarrega a tela atual silenciosamente
   -------------------------------------------------------------------------
   - a cada 10s enquanto a aba está visível (antes: 30s, mesmo escondida);
   - na hora em que o usuário volta para a aba/janela;
